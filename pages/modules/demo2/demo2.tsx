...
const Demo2: FC<Demo2Props> = () => {
    ...
    return (
        <div style={{ flex: 1, flexDirection: 'column', overflowY: 'auto', paddingInline: '15vw', display: 'flex', overflowX: 'hidden' }}>
            <h1 style={{ marginBottom: 10 }}>Optimize Article</h1>
            <textarea value={article} onChange={(event) => setArticle(event.target.value)} style={{ backgroundColor: Colors.disableLight, minHeight: 250, resize: 'none', border: 0, outline: 0, padding: 10, }} placeholder="Masukkan article..." />
            {
